const Footer = () => {
  return (
    <footer>
    <div className="tp-footer__area pt-120 pb-115">
          ...
          >
            <div className="tp-footer__widget footer-col-1">
              ...
              <div className="tp-footer__text">
                <p>
                  A smart and professional solution for all SaaS, software
                  and tech companies & digital agencies.{" "}
                </p>
              </div>
              <div className="tp-footer__contact-list">
                ...
                <div className="tp-footer__contact-item d-flex about-items-center">
                  ...
                  <div className="tp-footer__text">
                    <a href="https://template.wphix.com/cdn-cgi/l/email-protection#3f5c50514b5e5c4b7f56515950115c5052">
                      <span
                        className="__cf_email__"
                        data-cfemail="7f1c10110b1e1c0b3f16111910511c1012"
                      >
                        [email&#160;protected]
                      </span>
                    </a>
          ...
          >
            <div className="tp-footer__widget footer-col-4">
              ...
              <div className="tp-footer__thumb">
                ...
                <div className="tp-footer__social-box">
                  <a href="#">
      ...
      <div className="container custom-container-1">
        <div className="tp-copyright-3__border">
          <div className="row align-items-center">
            <div
              className="col-xl-4 col-lg-6 col-md-6 d-none d-md-block wow tpfadeUp"
              data-wow-duration=".9s"
              data-wow-delay=".3s"
            >
              <div className="tp-copyright-3__left-box">
                <a href="#" className="pr-5">
                  <img src="assets/img/footer/footer-3-2.png" alt="" />
                </a>
                <a href="#">
                  <img src="assets/img/footer/footer-3-3.png" alt="" />
                </a>
              </div>
            </div>
            <div
              ...
              data-wow-delay=".3s"
            >
              <div className="tp-copyright__text-2 text-center text-xl-start">
                <a href="#">
                  Full Copyright & Design By <strong>@Theme pure</strong> –
                  2023
                </a>
              </div>
            </div>
            <div
              className="col-xl-4 d-none d-xl-block wow tpfadeUp"
              data-wow-duration=".9s"
              data-wow-delay=".3s"
            >
              <div className="tp-copyright-3__right-box text-end">
