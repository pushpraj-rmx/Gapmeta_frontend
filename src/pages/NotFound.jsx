...
const NotFound = () => {
  return (
    <>
          ...
          <div className="tpoffcanvas__contact-info">
            ...
            <ul>
              ...
              <li>
                ...
                <a href="https://template.wphix.com/cdn-cgi/l/email-protection#0c7f63606d7e69686b694c6b616d6560226f6361">
                  <span
                    className="__cf_email__"
                    data-cfemail="a4d0ccc1c9c1d4d1d6c1e4c3c9c5cdc88ac7cbc9"
                  >
                    [email&#160;protected]
                  </span>
                </a>
      ...
      <main>
        <div
          className="tp-breadcrumb__area fix tp-breadcrumb-height"
                      ...
                      <span className="tp-title-shape">
                        ...
                        >
                          ...
                          <defs>
                            ...
                            >
                              <stop offset="0" stopColor="#FF307C" />
        ...
        <div className="tp-error__area pt-85 pb-120">
          <div className="container">
            <div className="row">
              <div className="col-xl-12">
                <div className="tp-error__item text-center">
                  <div className="tp-error__thumb">
                    <img src="assets/img/error/thumb-1-1.png" alt="" />
                  </div>
                  <div className="tp-error__content mb-40">
                    <h6 className="tp-error__title">
                  ...
                  <a className="tp-btn-purple-sm" href="index-2.html">
                    Back To Home
                  </a>
                </div>
              </div>
