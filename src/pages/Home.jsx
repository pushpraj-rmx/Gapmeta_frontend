...
const Home = () => {
  return (
    <>
                      ...
                      <ul>
                        <li className="has-dropdown">
                          ...
                          <div className="tp-submenu submenu has-homemenu">
                            <div className="row gx-6 row-cols-1 row-cols-md-2 row-cols-xl-5 row-cols-xxl-5">
      ...
      <main>
        <div className="tp-hero__area z-index fix">
          <div
            className="tp-hero__bg tp-hero__height p-relative fix"
          ...
          >
            ...
            <div className="tp-hero__contact-box d-none d-xxl-block">
              <a href="https://template.wphix.com/cdn-cgi/l/email-protection#f4b79b9a80959780b49399959d98da979b99">
                <span
                  className="__cf_email__"
                  data-cfemail="a2e1cdccd6c3c1d6e2c5cfc3cbce8cc1cdcf"
                >
                  [email&#160;protected]
                </span>
              </a>
            </div>
            <div className="tp-hero__social-box d-none d-xxl-block">
              <a href="#">Twitter</a>
              <a href="#">Facebook</a>
              <a href="#">Instagram</a>
            </div>
              ...
              <div className="row align-items-center">
                <div className="col-xl-6 col-lg-6">
                  <div className="tp-hero__left-box z-index">
                    <div className="tp-hero__section-box">
                      ...
                      >
                        ...
                        <span className="p-relative">
                          Digital
                          <span className="tp-slider-title-shape">
                            <svg
                              width="200"
                              height="6"
                              viewBox="0 0 200 6"
                            ...
                            >
                              ...
                              <defs>
                                ...
                                >
                                  <stop offset="0" stopColor="#EF5C92" />
                                  <stop offset="0.247843" stopColor="#A85CC5" />
                                  <stop offset="1" stopColor="#6698FB" />
                                </linearGradient>
                              </defs>
                            </svg>
                          </span>
                    ...
                    >
                      <p>
                        Beautiful, customizable template, with a ton of web
                        blocks to create an amazing website that looks
                      </p>
                ...
                <div className="col-xl-6 col-lg-6">
                  <div className="tp-hero__thumb-box p-relative text-center text-lg-end">
                    ...
                    <div className="tp-hero__shape-1 d-none d-xl-block">
                      <img src="assets/img/hero/hero-shape-1-1.png" alt="" />
                    </div>
                    <div className="tp-hero__shape-2 d-none d-lg-block">
                      <img src="assets/img/hero/hero-shape-1-2.png" alt="" />
                    </div>
                    <div className="tp-hero__shape-3 d-none d-md-block">
                      <img src="assets/img/hero/hero-shape-1-3.png" alt="" />
                    </div>
                    <div className="tp-hero__shape-4 d-none d-md-block">
        ...
        <div className="tp-feature__area p-relative">
          <div className="tp-feature__shape-1 d-none d-xl-block">
            ...
            <div className="tp-feature__border">
              <div className="row">
                ...
                <div
                  ...
                  data-wow-delay=".7s"
                >
                  <div className="tp-feature__item feature-col-3 border-none d-flex align-items-center">
                    <div className="tp-feature__icon">
                      <span>
                        <svg
                          width="70"
                    ...
                    <div className="tp-feature__content">
                      <h4 className="tp-feature__title">
                        absolutely guranteed
                      </h4>
                      <p>
                        Our online tools make the process as simple and clear as
                        possible, and
        ...
        <div className="tp-about__area tp-about__space fix p-relative">
          <div className="tp-about__shape-8 d-none d-xl-block">
            <img src="assets/img/about/about-shape1-8.png" alt="" />
          </div>
          <div className="tp-about__shape-9">
                ...
                <div className="tp-about__thumb-box">
                  ...
                  <div className="tp-about__thumb-text-box">
                    <div className="tp-about__thumb-text">
                      <span>
                        <b>25,000+</b> Customer Worldwide
                      </span>
                    </div>
                  </div>
                  <div className="tp-about__shape-1 d-none d-xxl-block">
                    <img src="assets/img/about/about-shape1-1.png" alt="" />
                  </div>
                  <div className="tp-about__shape-2 d-none d-xxl-block">
                  ...
                  <div className="tp-about__shape-4 d-none d-xxl-block">
                    <img src="assets/img/about/about-shape1-3.png" alt="" />
                  </div>
                  <div className="tp-about__shape-5 d-none d-xxl-block">
                    <img src="assets/img/about/about-shape1-4.png" alt="" />
                  </div>
                  <div className="tp-about__shape-6 d-none d-xxl-block">
                    <img src="assets/img/about/about-shape1-5.png" alt="" />
                  </div>
                  <div className="tp-about__shape-7 d-none d-xxl-block">
                  ...
                  <div className="tp-about__item-box d-flex align-items-center  justify-content-start justify-content-md-between">
                    <div className="tp-about__item d-flex align-items-start">
                      ...
                      <div className="tp-about__text">
                        <h5 className="tp-about__title-sm">Banners Printing</h5>
                    ...
                    <div className="tp-about__item d-flex align-items-start">
                      ...
                      <div className="tp-about__text">
                        <h5 className="tp-about__title-sm">
        ...
        <div className="tp-catagori__area p-relative pb-115 fix">
          <div className="tp-catagori__shape-1 d-none d-xxl-block">
            <img src="assets/img/catagori/shape-1-1.png" alt="" />
          </div>
          <div className="tp-catagori__shape-2 d-none d-xxl-block">
          ...
          <div className="container">
            ...
            <div className="tp-catagori__box p-relative">
              <div className="tp-catagori__wrapper">
                <div className="swiper-container tp-catagori__active">
                  <div className="swiper-wrapper">
                    <div className="swiper-slide">
                      <div className="tp-catagori__catagori-wrap">
                        <div className="tp-catagori__catagori-box">
                          <div className="row g-0">
                              ...
                              <div className="tp-catagori__border">
                                <div className="tp-catagori__item p-relative d-flex align-items-center">
                                  ...
                                  <div className="tp-catagori__text">
                                    ...
                                    <p>
                                      Our online tools make the process as
                            ...
                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-catagori-3">
                              <div className="tp-catagori__border">
                                <div className="tp-catagori__item tp-catagori__item-2 p-relative d-flex align-items-center">
                                  <div className="tp-catagori__item-text">
                                    <span>80+ sTYLE</span>
                                  </div>
                                  <div className="tp-catagori__thumb">
              ...
              <div className="tp-catagori-slider-dots"></div>
            </div>
            <div className="col-xl-12">
              <div className="tp-catagori__button text-center mt-70">
                <a className="tp-btn-gradiant" href="contact.html">
                  Let’s talk — Send a message
                  <i>
                    <svg
                      width="18"
                    ...
                    <div className="swiper-wrapper">
                        ...
                        <div className="tp-service__item fix p-relative">
                          ...
                          <div className="tp-service__bottom-box">
                            ...
                            <div className="tp-service__content">
                              <h4 className="tp-service__title p-relative">
                              ...
                              <p>
                                ...
                                private houses and cottages since 19 Our{" "}
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="swiper-slide">
                        <div className="tp-service__item fix p-relative">
                          <div className="tp-service__thumb">
                            <img
                              src="assets/img/service/service-1-2.jpg"
                              alt=""
                            />
                          </div>
                          <div className="tp-service__bottom-box">
                      ...
                      <div className="swiper-slide">
                        <div className="tp-service__item fix p-relative">
                          <div className="tp-service__thumb">
                            <img
                              src="assets/img/service/service-1-3.jpg"
                              alt=""
                            />
                          </div>
                          <div className="tp-service__bottom-box">
        ...
        <div className="tp-slider-text__area tp-slider-text__space fix">
          <div className="container-fluid g-0">
            <div className="tp-slider-text__bg">
              <div className="row">
                <div className="col-xl-12">
                  <div className="tp-slider-text-active" dir="rtl">
                    <div className="tp-slider-text__item">
                      <div className="tp-slider-text__text">
            ...
            <div className="tp-slider-text-2__bg">
              <div className="row">
                <div className="col-xl-12">
                  <div className="tp-slider-text-2-active">
                    <div className="tp-slider-text-2__item">
                      <div className="tp-slider-text-2__text">
                        <span>Custom Print Design</span>
                        <svg
                          width="17"
                          height="19"
        ...
        <div className="tp-business__area fix mt-30 mb-115">
                ...
                <div className="row row-cols-xl-5 row-cols-lg-5 row-cols-md-3 row-cols-sm-3 row-cols-2">
                  <div className="col mb-30">
                    <div className="tp-business__item text-center">
                      ...
                      <h5 className="tp-business__title">
                        Eco-friendly Local <br /> Products
                      </h5>
                    </div>
                  </div>
                  <div className="col mb-30">
                    <div className="tp-business__item text-center">
                      ...
                      <h5 className="tp-business__title">
                        500,00+ customisable <br /> products
                      </h5>
                    </div>
                  </div>
                  <div className="col mb-30">
                    ...
                    <ul>
                      <li>
                        <div className="tp-business__content d-flex align-items-start">
                          ...
                          <div className="tp-business__content-text">
                            <h5 className="tp-business__content-title">
                              First of all have to Add your shirt design
                            </h5>
                            <p>
                              Lorem ipsum det, cowec tetur duis nec fringi det,
                              consec t eturlagix adipiscing eliet,
                            </p>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div className="tp-business__content active d-flex align-items-start">
                          <div className="tp-business__number">
                            <span>02</span>
                          </div>
                          <div className="tp-business__content-text">
                            <h5 className="tp-business__content-title">
                              Pixel perfect and accurate Great printing
                            </h5>
                            <p>
                              Lorem ipsum det, cowec tetur duis nec fringi det,
                              consec t eturlagix adipiscing eliet,
                      ...
                      <li>
                        <div className="tp-business__content d-flex align-items-start">
                          ...
                          <div className="tp-business__content-text">
                            <h5 className="tp-business__content-title">
                              Low cost & digital printing agency & Enjoy It
                            </h5>
                            <p>
                              Lorem ipsum det, cowec tetur duis nec fringi det,
                              consec t eturlagix adipiscing eliet,
        ...
        <div className="tp-testimonial__area p-relative fix purple-bg pt-125 pb-85">
          <div className="tp-testimonial__shape-1">
            <img src="assets/img/testimonial/shape-1-1.png" alt="" />
          </div>
          <div className="tp-testimonial__shape-2">
            <img src="assets/img/testimonial/shape-1-2.png" alt="" />
          </div>
          <div className="container">
            <div className="row align-items-end">
              <div className="col-xl-5 col-lg-5">
                <div className="tp-testimonial__left-box z-index">
                  <div className="tp-testimonial__section-box pb-10">
                  ...
                  <div className="tp-testimonial__button">
                    <p>
                      Beautiful, customizable template, with a ton of blocks to
                      create an amazing website that
                    </p>
                    <div className="d-none d-md-block">
                      <a className="tp-btn-lg" href="contact.html">
                        Let’s talk — Send a message
                        <i>
                          <svg
                            width="18"
                    ...
                    <div className="swiper-wrapper">
                      <div className="swiper-slide">
                        <div className="tp-testimonial__item">
                          <div className="tp-testimonial__top-box d-flex align-items-center justify-content-between">
                            <div className="tp-testimonial__author-box d-flex align-items-center">
                              ...
                              <div className="tp-testimonial__author-info">
                                <h5 className="tp-testimonial__author-name">
                                  Mathias Herasen
                                </h5>
                                <span>
                          ...
                          <div className="tp-testimonial__content">
                            <p>
                              “Modern customer service software solution that
                              was exactly what we were looking for. From the
                              feature set to the pricing model primchat great
                              for us.”
                            </p>
        ...
        <div className="tp-brand-3__area pt-50 fix">
          <div className="container-fluid gx-0">
            <div className="tp-brand-3-active" dir="rtl">
              <div className="tp-brand-3__item">
        ...
        <div className="tp-brand-4__area fix">
          <div className="container-fluid gx-0">
            <div className="tp-brand-4-active">
              <div className="tp-brand-4__item">
        ...
        <div className="tp-blog__area pt-90 pb-80">
          <div className="container">
            <div className="row">
              <div className="col-xl-12">
                <div className="tp-blog__section-box text-center pb-55">
                  <span className="tp-section-subtitle">
                    Recent News & Blog
                  </span>
                  <h3 className="tp-section-title">
                ...
                <div className="tp-blog__item">
                  <div className="tp-blog__thumb">
                    <a href="blog-details.html">
                      <img
                        className="w-100"
                        src="assets/img/blog/blog1-1.jpg"
                        alt=""
                      />
                    </a>
                  ...
                  <div className="tp-blog__content">
                    <div className="tp-blog__meta">
                      <span>
                        Posted by 21 lab -<b>Nov 13, 2022</b>
                      </span>
                    </div>
                    <h5 className="tp-blog__title">
                      <a href="blog-details.html">
                        How Chatbots Can Help You <br />
                        Drive More Sales
                      </a>
                    </h5>
                  </div>
                ...
                <div className="tp-blog__item">
                  <div className="tp-blog__thumb">
                    <a href="blog-details.html">
                      <img
                        className="w-100"
                        src="assets/img/blog/blog1-2.jpg"
                        alt=""
                      />
                    </a>
                    <div className="tp-blog__thumb-text">
                ...
                <div className="tp-blog__item">
                  <div className="tp-blog__thumb">
                    <a href="blog-details.html">
                      <img
                        className="w-100"
                        src="assets/img/blog/blog1-3.jpg"
                        alt=""
                      />
                    </a>
                    <div className="tp-blog__thumb-text">
        ...
        <div className="tp-cta__area tp-cta__grey-bg fix">
          <div className="container">
            <div
              className="tp-cta__bg p-relative"
              data-background="assets/img/cta/cta-bg-1.png"
            >
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="tp-cta__content text-center">
                    ...
                    <a className="tp-btn-lg" href="about-us.html">
                      Explore More
                      <i>
                        <svg
                          width="18"
      ...
      <footer>
        <div className="tp-footer__area tp-footer__space p-relative grey-bg pb-80">
                ...
                <div className="tp-footer__widget z-index footer-col-1">
                  ...
                  <div className="tp-footer__contact-list">
                    ...
                    <div className="tp-footer__contact-item d-flex about-items-center">
                      ...
                      <div className="tp-footer__text">
                        <a href="https://template.wphix.com/cdn-cgi/l/email-protection#15767a7b61747661557c7b737a3b767a78">
                          <span
                            className="__cf_email__"
                            data-cfemail="294a46475d484a5d6940474f46074a4644"
                          >
                            [email&#160;protected]
                          </span>
                        </a>
              ...
              >
                <div className="tp-footer__widget footer-col-4">
                  ...
                  <div className="tp-footer__thumb">
                    ...
                    <a href="#">
                      <img src="assets/img/footer/footer-1-1.png" alt="" />
                    </a>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="tp-copyright__wrapper d-flex align-items-center justify-content-sm-between justify-content-center">
                  ...
                  <div className="tp-copyright__text text-center">
                    <span>
                      Full Copyright & Design By <i>@Theme pure</i> – 2023
                    </span>
                  </div>
                  <div className="tp-copyright__lang d-none d-sm-block">
                    <ul>
                      <li>
                        <a
                          id="tp-copyright__lang-toogle"
      ...
      {/* <script
        data-cfasync="false"
        src="https://template.wphix.com/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"
      ></script>
