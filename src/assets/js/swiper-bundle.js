...
!(function (e, t) {
  ...
  function u(e) {
    ...
    return (u = function (e) {
      ...
      return (
        (i.prototype = Object.create(e.prototype, { constructor: { value: i, enumerable: !1, writable: !0, configurable: !0 } })), d(i, e)
      );
    })(e);
  }
  var h = (function (e) {
        ...
        for (var l = i.split(" "), o = 0; o < l.length; o += 1)
          for (var d = l[o], p = 0; p < this.length; p += 1) {
            var c = this[p],
              u = void 0;
            if (
              (!s && c.dom7Listeners ? (u = c.dom7Listeners[d]) : s && c.dom7LiveListeners && (u = c.dom7LiveListeners[d]), u && u.length)
            )
      ...
      w ||
        (w = (function () {
          ...
          return {
            ...
            isSafari:
              ((e = t.navigator.userAgent.toLowerCase()), e.indexOf("safari") >= 0 && e.indexOf("chrome") < 0 && e.indexOf("android") < 0),
  ...
  function A(e) {
    ...
    if ((o.originalEvent && (o = o.originalEvent), i.isTouched)) {
      if (!i.isTouchEvent || "touchmove" === o.type) {
        ...
        if (!a.allowTouchMove)
          return (
            (a.allowClick = !1), void (i.isTouched && (S(n, { startX: p, startY: c, currentX: p, currentY: c }), (i.touchStartTime = x())))
          );
            ...
            if (
              ...
              if (
                ...
                f > 0 && i.currentTranslate > a.minTranslate()
                  ? ((g = !1),
                    s.resistance && (i.currentTranslate = a.minTranslate() - 1 + Math.pow(-a.minTranslate() + i.startTranslate + f, b)))
                  : f < 0 &&
  ...
  function D(e) {
    var t = this,
      ...
      d = e;
    if (
      (d.originalEvent && (d = d.originalEvent), a.allowTouchCallbacks && t.emit("touchEnd", d), (a.allowTouchCallbacks = !1), !a.isTouched)
    )
    ...
    if (
      (t.allowClick &&
        (t.updateClickedSlide(d), t.emit("tap click", d), u < 300 && c - a.lastClickTime < 300 && t.emit("doubleTap doubleClick", d)),
      (a.lastClickTime = x()),
      E(function () {
        ...
        if (i.freeModeMomentum) {
          ...
          if (w < t.maxTranslate())
            i.freeModeMomentumBounce
              ? (w + t.maxTranslate() < -S && (w = t.maxTranslate() - S), (y = t.maxTranslate()), (C = !0), (a.allowMomentumBounce = !0))
              : (w = t.maxTranslate()),
              i.loop && i.centeredSlides && (T = !0);
          else if (w > t.minTranslate())
            i.freeModeMomentumBounce
              ? (w - t.minTranslate() > S && (w = t.minTranslate() + S), (y = t.minTranslate()), (C = !0), (a.allowMomentumBounce = !0))
              : (w = t.minTranslate()),
              i.loop && i.centeredSlides && (T = !0);
      ...
      update: {
        ...
        updateSlides: function () {
          ...
          if (void 0 !== n) {
            ...
            for (var P, k, L, $ = s.slidesPerColumn, I = M / $, O = Math.floor(h / s.slidesPerColumn), A = 0; A < h; A += 1) {
              ...
              if (s.slidesPerColumn > 1) {
                ...
                if ("row" === s.slidesPerColumnFill && s.slidesPerGroup > 1) {
                  ...
                  (N = (G = X - (B = Math.floor(X / Y)) * Y + H * s.slidesPerGroup) + (B * M) / $),
                    D.css({
                  ...
                  "column" === s.slidesPerColumnFill
                    ? ((B = A - (G = Math.floor(A / $)) * $), (G > O || (G === O && B === $ - 1)) && (B += 1) >= $ && ((B = 0), (G += 1)))
              ...
              if ("none" !== D.css("display")) {
                if ("auto" === s.slidesPerView) {
                  ...
                  if ((V && (D[0].style.transform = "none"), W && (D[0].style.webkitTransform = "none"), s.roundLengths))
            ...
            if (
              ...
              o && d && ("slide" === s.effect || "coverflow" === s.effect) && r.css({ width: e.virtualSize + s.spaceBetween + "px" }),
              s.setWrapperSize)
            )
              r.css((((k = {})[t("width")] = e.virtualSize + s.spaceBetween + "px"), k));
            if (s.slidesPerColumn > 1)
              if (
                ((e.virtualSize = (z + s.spaceBetween) * M),
                (e.virtualSize = Math.ceil(e.virtualSize / s.slidesPerColumn) - s.spaceBetween),
                r.css((((L = {})[t("width")] = e.virtualSize + s.spaceBetween + "px"), L)),
                s.centeredSlides)
              ) {
                P = [];
        ...
        updateSlidesClasses: function () {
          ...
          a.removeClass(
            ...
            (e = l ? t.$wrapperEl.find("." + i.slideClass + '[data-swiper-slide-index="' + r + '"]') : a.eq(r)).addClass(
              i.slideActiveClass,
            ),
            i.loop &&
        ...
        attachEvents: function () {
          ...
          (a.preventClicks || a.preventClicksPropagation) && s.addEventListener("click", e.onClick, !0),
            ...
            a.updateOnWindowResize
              ? e.on(l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", N, !0)
      ...
      images: {
        loadImage: function (e, t, a, i, s, r) {
          ...
          m(e).parent("picture")[0] || (e.complete && s)
            ? d()
            : t
              ? (((n = new o.Image()).onload = d), (n.onerror = d), i && (n.sizes = i), a && (n.srcset = a), t && (n.src = t))
              : d();
        },
  ...
  var F = {
      update: function (e) {
        ...
        if ((S(t.virtual, { from: y, to: E, offset: x, slidesGrid: t.slidesGrid }), p === y && c === E && !e))
    ...
    j = {
      handle: function (e) {
        ...
        if (
          ...
          t.isHorizontal()
            ? ((p || c || u || h) && (n.preventDefault ? n.preventDefault() : (n.returnValue = !1)),
              (((c || h) && !s) || ((p || u) && s)) && t.slideNext(),
              (((p || u) && !s) || ((c || h) && s)) && t.slidePrev())
            : ((p || c || v || f) && (n.preventDefault ? n.preventDefault() : (n.returnValue = !1)),
              (c || f) && t.slideNext(),
              (p || v) && t.slidePrev()),
            t.emit("keyPress", o);
        }
  ...
  var U = {
      ...
      handle: function (e) {
        ...
        if (
          ...
          if (
            (T.push(y),
            C
              ? (y.direction !== C.direction || y.delta > C.delta || y.time > C.time + 150) && a.mousewheel.animateSlider(y)
    ...
    Z = {
      update: function () {
        ...
        if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
          ...
          if (
            (e.params.loop
              ? ((i = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)) > s - 1 - 2 * e.loopedSlides &&
      ...
      checkInViewOnLoad: function () {
        ...
        if (t && !t.destroyed) {
          ...
          o
            ...
            : t.lazy.scrollHandlerAttached || ((t.lazy.scrollHandlerAttached = !0), a.on("scroll", t.lazy.checkInViewOnLoad));
        }
      },
    },
    ae = {
      LinearSpline: function (e, t) {
        ...
        return (
          ...
          (this.interpolate = function (e) {
            return e
              ? ((n = l(this.x, e)), (r = n - 1), ((e - this.x[r]) * (this.y[n] - this.y[r])) / (this.x[n] - this.x[r]) + this.y[r])
              : 0;
          }),
          this
        );
    ...
    ie = {
      ...
      updateNavigation: function () {
        ...
        if (!e.params.loop && e.navigation) {
          ...
          i &&
            i.length > 0 &&
            (e.isBeginning ? (e.a11y.disableEl(i), e.a11y.makeElNotFocusable(i)) : (e.a11y.enableEl(i), e.a11y.makeElFocusable(i))),
            a &&
              a.length > 0 &&
              (e.isEnd ? (e.a11y.disableEl(a), e.a11y.makeElNotFocusable(a)) : (e.a11y.enableEl(a), e.a11y.makeElFocusable(a)));
        }
      },
          ...
          e.pagination.bullets.each(function (a) {
            ...
            e.a11y.makeElFocusable(i),
              e.params.pagination.renderBullet ||
                (e.a11y.addElRole(i, "button"), e.a11y.addElLabel(i, t.paginationBulletMessage.replace(/\{\{index\}\}/, i.index() + 1)));
          });
      },
      init: function () {
        var e = this,
        ...
        e.a11y.addElId(n, l),
          ...
          s &&
            ...
            "BUTTON" !== s[0].tagName && (e.a11y.addElRole(s, "button"), s.on("keydown", e.a11y.onEnterOrSpaceKey)),
            e.a11y.addElLabel(s, t.nextSlideMessage),
            e.a11y.addElControls(s, l)),
          r &&
            r.length &&
            (e.a11y.makeElFocusable(r),
            "BUTTON" !== r[0].tagName && (e.a11y.addElRole(r, "button"), r.on("keydown", e.a11y.onEnterOrSpaceKey)),
      ...
      destroy: function () {
        ...
        a.a11y.liveRegion && a.a11y.liveRegion.length > 0 && a.a11y.liveRegion.remove(),
          ...
          a.pagination &&
            ...
            a.pagination.$el.off("keydown", "." + a.params.pagination.bulletClass.replace(/ /g, "."), a.a11y.onEnterOrSpaceKey);
      },
    },
    se = {
      init: function () {
      ...
      setHistory: function (e, t) {
        ...
        if (a.history.initialized && a.params.history.enabled) {
          ...
          (o && o.value === n) ||
            (a.params.history.replaceState ? i.history.replaceState({ value: n }, null, n) : i.history.pushState({ value: n }, null, n));
        }
      },
      slugify: function (e) {
        return e
    ...
    oe = {
      setTranslate: function () {
        ...
        i.transform(
          "translate3d(0px,0," + I + "px) rotateX(" + (t.isHorizontal() ? 0 : h) + "deg) rotateY(" + (t.isHorizontal() ? -h : 0) + "deg)",
        );
      },
      setTransition: function (e) {
        var t = this,
        ...
        for (var e = this, t = e.slides, a = e.rtlTranslate, i = 0; i < t.length; i += 1) {
          ...
          if (
            ...
            0 === p.length && ((p = m('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "left" : "top") + '"></div>')), s.append(p)),
              0 === c.length &&
                ((c = m('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? "right" : "bottom") + '"></div>')), s.append(c)),
      ...
      init: function () {
        ...
        return (
          t.swiper instanceof a
            ...
            : C(t.swiper) &&
              ((e.thumbs.swiper = new a(S({}, t.swiper, { watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1 }))),
          ...
          if (t.realIndex !== a.realIndex || r) {
            ...
            r && (n += "next" === l ? s : -1 * s),
              a.visibleSlidesIndexes &&
                ...
                (a.params.centeredSlides ? (n = n > o ? n - Math.floor(i / 2) + 1 : n + Math.floor(i / 2) - 1) : n > o && (n = n - i + 1),
        ...
        on: {
          ...
          click: function (e, t) {
            ...
            if (
              ...
              if (
                e.navigation &&
                ((e.navigation.nextEl && a === e.navigation.nextEl) || (e.navigation.prevEl && a === e.navigation.prevEl))
              )
                return;
