        ...
        for (i in n[o])
          (s = n[o][i]),
            n[o].hasOwnProperty(i) &&
              void 0 !== s &&
              (t.isPlainObject(s) ? (e[i] = t.isPlainObject(e[i]) ? t.widget.extend({}, e[i], s) : t.widget.extend({}, s)) : (e[i] = s));
      return e;
    }),
      ...
      (t.position = {
        ...
        (t.fn.position = function (e) {
          ...
          return (
            ...
            $[0].preventDefault && (e.at = "left top"),
            (d = m.width),
            (p = m.height),
            (f = m.offset),
            (g = t.extend({}, f)),
            ...
            this.each(function () {
              ...
              "right" === e.my[0] ? (C.left -= r) : "center" === e.my[0] && (C.left -= r / 2),
                "bottom" === e.my[1] ? (C.top -= h) : "center" === e.my[1] && (C.top -= h / 2),
                (C.left += D[0]),
                (C.top += D[1]),
                (n = { marginLeft: m, marginTop: v }),
                t.each(["left", "top"], function (i, s) {
                  t.ui.position[w[i]] &&
                    t.ui.position[w[i]][s](C, {
                      targetWidth: d,
                      targetHeight: p,
                      elemWidth: r,
                      elemHeight: h,
                ...
                e.using &&
                  (o = function (t) {
                    var n = f.left - C.left,
                      ...
                      c = l + p - h,
                      u = {
                        target: { element: $, left: f.left, top: f.top, width: d, height: p },
                        element: { element: a, left: C.left, top: C.top, width: r, height: h },
                        horizontal: o < 0 ? "left" : n > 0 ? "right" : "center",
                        vertical: c < 0 ? "top" : l > 0 ? "bottom" : "middle",
                      };
                    d < r && s(n + o) < d && (u.horizontal = "center"),
                      p < h && s(l + c) < p && (u.vertical = "middle"),
                      i(s(n), s(o)) > i(s(l), s(c)) ? (u.important = "horizontal") : (u.important = "vertical"),
                      e.using.call(this, t, u);
                  }),
                a.offset(t.extend(C, { using: o }));
            })
          );
        }),
        (t.ui.position = {
          ...
          flip: {
            left: function (t, e) {
              var i,
                ...
                f = -2 * e.offset[0];
              c < 0
                ? ((i = t.left + d + p + f + e.collisionWidth - r - a) < 0 || i < s(c)) && (t.left += d + p + f)
            ...
            top: function (t, e) {
              var i,
                ...
                f = -2 * e.offset[1];
              c < 0
                ? ((n = t.top + d + p + f + e.collisionHeight - r - a) < 0 || n < s(c)) && (t.top += d + p + f)
...
*/ (function (t, e) {
      var i,
        ...
        a = {
          ...
          hsla: {
            props: { hue: { idx: 0, type: "degrees" }, saturation: { idx: 1, type: "percent" }, lightness: { idx: 2, type: "percent" } },
          },
        },
      ...
      function u(t, e, i) {
        ...
        return null == t
          ? i || !e.def
            ? null
            : e.def
          : isNaN((t = s.floor ? ~~t : parseFloat(t)))
            ? e.def
            : s.mod
              ? (t + s.mod) % s.mod
              : 0 > t
        ...
        (o.fn = t.extend(o.prototype, {
          parse: function (s, n, r, l) {
            ...
            var h = this,
              p = t.type(s),
              f = (this._rgba = []);
            return (n !== e && ((s = [s, n, r, l]), (p = "array")), "string" === p)
              ? this.parse(d(s) || i._default)
              : "array" === p
                ? (c(a.rgba.props, function (t, e) {
                    f[e.idx] = u(s[e.idx], e);
                  }),
                  this)
                : "object" === p
            ...
            return (
              ...
              c(n.props, function (t, s) {
                ...
                null !== a &&
                  (null === o
                    ? (d[n] = a)
                    : (l.mod && (a - o > l.mod / 2 ? (o += l.mod) : o - a > l.mod / 2 && (o -= l.mod)), (d[n] = u((a - o) * e + o, s))));
              }),
              this[s](d)
            );
          },
            ...
            c(a, function (e, n) {
              !o.fn[e] &&
                (o.fn[e] = function (o) {
                  ...
                  return "undefined" === r
                    ? c
                    : ("function" === r && ((o = o.call(this, c)), (r = t.type(o))), null == o && n.empty)
                      ? this
                      : ("string" === r && (a = s.exec(o)) && (o = c + parseFloat(a[2]) * ("+" === a[1] ? 1 : -1)),
                        (h[n.idx] = o),
                        this[l](h));
                });
            });
          ...
          c(e.split(" "), function (e, i) {
            (t.cssHooks[i] = {
              ...
              (t.fx.step[i] = function (e) {
                e.colorInit || ((e.start = o(e.elem, i)), (e.end = o(e.end)), (e.colorInit = !0)),
      ...
      t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function (e, i) {
        ...
        t.fn.extend({
          ...
          removeClass:
            ((i = t.fn.removeClass),
            function (e, s, n, o) {
              return arguments.length > 1 ? t.effects.animateClass.call(this, { remove: e }, s, n, o) : i.apply(this, arguments);
            }),
          toggleClass:
            ((s = t.fn.toggleClass),
            function (e, i, n, o, a) {
    ...
    (function () {
      ...
      function a(e) {
        return (
          !!(!e || "number" == typeof e || t.fx.speeds[e] || ("string" == typeof e && !t.effects.effect[e]) || t.isFunction(e)) ||
  ...
  t.effects.define("blind", "hide", function (e, i) {
    ...
    t.effects.define("bounce", function (e, i) {
      ...
      for (
        ...
        ((s = {})[m] = (v ? "-=" : "+=") + u), a.animate(s, f, g).animate(n, f, g), (u = l ? 2 * u : u / 2);
      l && (((s = { opacity: 0 })[m] = (v ? "-=" : "+=") + u), a.animate(s, f, g)), a.queue(i), t.effects.unshift(a, $, p + 1);
    }),
    ...
    t.effects.define("explode", "hide", function (e, i) {
      ...
      for (s = 0; s < h; s++)
        for (n = 0, a = p.top + s * g, l = s - (h - 1) / 2; n < c; n++)
          (o = p.left + n * f),
            (r = n - (c - 1) / 2),
            u
              .clone()
              ...
              .animate({ left: o + (d ? 0 : r * f), top: a + (d ? 0 : l * g), opacity: d ? 1 : 0 }, e.duration || 500, e.easing, v);
    }),
    ...
    t.effects.define("fold", "hide", function (e, i) {
      var s = t(this),
        ...
        p = [c[r[0]], c[r[1]]],
        f = s.queue().length;
      a && (o = (parseInt(a[1], 10) / 100) * p["hide" === n ? 0 : 1]),
        (u.clip[r[0]] = o),
        (d.clip[r[0]] = o),
        (d.clip[r[1]] = 0),
    ...
    t.effects.define("size", function (e, i) {
      ...
      t.effects.createPlaceholder(a),
        "show" === c && ((o = v), (v = b), (b = o)),
        (n = { from: { y: v.height / m.height, x: v.width / m.width }, to: { y: b.height / m.height, x: b.width / m.width } }),
        ("box" === d || "both" === d) &&
          (n.from.y !== n.to.y && ((v = t.effects.setTransition(a, l, n.from.y, v)), (b = t.effects.setTransition(a, l, n.to.y, b))),
          n.from.x !== n.to.x && ((v = t.effects.setTransition(a, h, n.from.x, v)), (b = t.effects.setTransition(a, h, n.to.x, b)))),
        ("content" === d || "both" === d) &&
          n.from.y !== n.to.y &&
          ((v = t.effects.setTransition(a, r, n.from.y, v)), (b = t.effects.setTransition(a, r, n.to.y, b))),
        p &&
...
*/ (t.ui.focusable = function (e, i) {
      ...
      return "area" === l
        ? ((n = (s = e.parentNode).name),
          !!e.href && !!n && "map" === s.nodeName.toLowerCase() && (o = t("img[usemap='#" + n + "']")).length > 0 && o.is(":visible"))
        : (/^(input|select|textarea|button|object)$/.test(l)
          ...
          a &&
            t(e).is(":visible") &&
            (function t(e) {
              for (var i = e.css("visibility"); "inherit" === i; ) i = (e = e.parent()).css("visibility");
              return "hidden" !== i;
            })(t(e)));
    }),
    t.extend(t.expr[":"], {
        ...
        switch (e.keyCode) {
          ...
          default:
            (a = !1),
              ...
              (i = o && -1 !== i.index(this.active.next()) ? this.active.nextAll(".ui-menu-item") : i).length ||
...
*/ t.widget("ui.autocomplete", {
      ...
      _create: function () {
        ...
        (this.isMultiLine = o || (!a && this._isContentEditable(this.element))),
          ...
          (this.liveRegion = t("<div>", { role: "status", "aria-live": "assertive", "aria-relevant": "additions" }).appendTo(
      ...
      search: function (t, e) {
        return ((t = null != t ? t : this._value()), (this.term = this._value()), t.length < this.options.minLength)
          ? this.close(e)
...
*/ var m = /ui-corner-([a-z]){2,6}/g;
  function v() {
    (this._curInst = null),
      ...
      (this.dpDiv = b(
        t("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"),
      ));
  }
  function b(e) {
  ...
  function $() {
    t.datepicker._isDisabledDatepicker(a.inline ? a.dpDiv.parent()[0] : a.input[0]) ||
      ...
      (t.fn.button =
        ...
        function () {
          return !this.length ||
            ...
            ? s.apply(this, arguments)
            : (t.ui.checkboxradio || t.error("Checkboxradio widget missing"), 0 === arguments.length)
    ...
    t.extend(v.prototype, {
            ...
            i.trigger.on("click", function () {
              return (
                t.datepicker._datepickerShowing && t.datepicker._lastInput === e[0]
                  ...
                  : (t.datepicker._datepickerShowing && t.datepicker._lastInput !== e[0] && t.datepicker._hideDatepicker(),
      ...
      _doKeyDown: function (e) {
        ...
        if (((o._keyEvent = !0), t.datepicker._datepickerShowing))
          switch (e.keyCode) {
            ...
            case 13:
              return (
                (n = t("td." + t.datepicker._dayOverClass + ":not(." + t.datepicker._currentClass + ")", o.dpDiv))[0] &&
                ...
                i.dpDiv.css(
                  ...
                  (function t(e) {
                    for (var i, s; e.length && e[0] !== document; ) {
                      if (
                        ("absolute" === (i = e.css("position")) || "relative" === i || "fixed" === i) &&
                        ((s = parseInt(e.css("zIndex"), 10)), !isNaN(s) && 0 !== s)
                      )
                        return s;
                      e = e.parent();
                    }
      ...
      parseDate: function (e, i, s) {
        ...
        if (
          (-1 === g
            ...
            : g < 100 && (g += new Date().getFullYear() - (new Date().getFullYear() % 100) + (g <= c ? 0 : -100)),
          b > -1)
        )
              ...
              switch (t.charAt(s)) {
                ...
                case "o":
                  u += h(
                    "o",
                    Math.round(
                      (new Date(e.getFullYear(), e.getMonth(), e.getDate()).getTime() - new Date(e.getFullYear(), 0, 0).getTime()) / 864e5,
                    ),
                    3,
                  );
                  break;
      ...
      _determineDate: function (e, i, s) {
        var n = function (t) {
          ...
          a =
            null == i || "" === i ? s : "string" == typeof i ? o(i) : "number" == typeof i ? (isNaN(i) ? s : n(i)) : new Date(i.getTime());
        return (
          (a = a && "Invalid Date" === a.toString() ? s : a) && (a.setHours(0), a.setMinutes(0), a.setSeconds(0), a.setMilliseconds(0)),
      ...
      _generateHTML: function (t) {
        ...
        if ((Z < 0 && ((Z += 12), tt--), J))
          for (
            e = this._daylightSavingAdjust(new Date(J.getFullYear(), J.getMonth() - K[0] * K[1] + 1, J.getDate())), e = Q && e < Q ? Q : e;
        ...
        for (
          ...
          for (x = 0, k = "", this.maxRows = 4; x < K[1]; x++) {
            if (((C = this._daylightSavingAdjust(new Date(tt, Z, t.selectedDay))), (D = " ui-corner-all"), (P = ""), X)) {
              if (((P += "<div class='ui-datepicker-group"), K[1] > 1))
                switch (x) {
                  case 0:
            ...
            for (
              P +=
                ...
                D +
                "'>" +
                (/all|left/.test(D) && 0 === w ? (B ? o : s) : "") +
                (/all|right/.test(D) && 0 === w ? (B ? s : o) : "") +
                this._generateMonthYearHeader(t, Z, tt, Q, J, w > 0 || x > 0, f, g) +
              ...
              (I = (_ + c) % 7),
                (T +=
                  "<th scope='col'" +
                  ((_ + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") +
                  "><span title='" +
                  d[I] +
                  "'>" +
                  p[I] +
            ...
            for (
              P += T + "</tr></thead><tbody>",
                ...
                M = Math.ceil(((H = (this._getFirstDayOfMonth(tt, Z) - c + 7) % 7) + S) / 7),
                z = X && this.maxRows > M ? this.maxRows : M,
                this.maxRows = z,
                O = this._daylightSavingAdjust(new Date(tt, Z, 1 - H)),
                A = 0;
              A < z;
              A++
            ) {
              for (
                P += "<tr>", W = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(O) + "</td>" : "", _ = 0;
                _ < 7;
                _++
              )
                (E = m ? m.apply(t.input ? t.input[0] : null, [O]) : [!0, ""]),
                  (F = ((N = O.getMonth() !== Z) && !b) || !E[0] || (Q && O < Q) || (J && O > J)),
                  (W +=
                    "<td class='" +
                    ((_ + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") +
                    (N ? " ui-datepicker-other-month" : "") +
                    ((O.getTime() === C.getTime() && Z === t.selectedMonth && t._keyEvent) ||
                    ($.getTime() === O.getTime() && $.getTime() === C.getTime())
                      ? " " + this._dayOverClass
                      : "") +
                    ...
                    (N && !v
                      ...
                      : " " +
                        E[1] +
                        (O.getTime() === G.getTime() ? " " + this._currentClass : "") +
                        (O.getTime() === R.getTime() ? " ui-datepicker-today" : "")) +
                    "'" +
                    ((!N || v) && E[2] ? " title='" + E[2].replace(/'/g, "&#39;") + "'" : "") +
                    (F
                      ? ""
                    ...
                    (N && !v
                      ...
                      : F
                        ...
                        : "<a class='ui-state-default" +
                          ...
                          (O.getTime() === G.getTime() ? " ui-state-active" : "") +
            ...
            ++Z > 11 && ((Z = 0), tt++),
              (P +=
                "</tbody></table>" +
                (X ? "</div>" + (K[0] > 0 && x === K[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")),
              (k += P);
          }
          y += k;
        }
  ...
  t(document).on("mouseup", function () {
    ...
    t.widget("ui.mouse", {
      ...
      _mouseMove: function (e) {
        ...
        return ((e.which || e.button) && (this._mouseMoved = !0), this._mouseStarted)
...
*/ t.widget("ui.draggable", t.ui.mouse, {
      ...
      _mouseCapture: function (e) {
        ...
        return (
          ...
          !!this.handle && (this._blurActiveElement(e), this._blockFrames(!0 === i.iframeFix ? "iframe" : i.iframeFix), !0))
        );
      },
      ...
      cancel: function () {
        return (
          this.helper.is(".ui-draggable-dragging") ? this._mouseUp(new t.Event("mouseup", { target: this.element[0] })) : this._clear(),
          this
        );
      },
      ...
      drag: function (e, i, s) {
        ...
        for (d = s.snapElements.length - 1; d >= 0; d--) {
          if (
            ...
            v < l - g || m > h + g || $ < c - g || b > u + g || !t.contains(s.snapElements[d].item.ownerDocument, s.snapElements[d].item))
          ) {
...
*/ t.widget("ui.resizable", t.ui.mouse, {
      ...
      _setupHandles: function () {
        ...
        if (
          ...
          for (
            "all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), s = this.handles.split(","), this.handles = {}, i = 0;
            i < s.length;
            i++
          )
        ...
        (this._renderAxis = function (e) {
          ...
          this._handles.on("mouseover", function () {
            r.resizing ||
              (this.className && (o = this.className.match(/ui-resizable-(se|sw|ne|nw|n|e|s|w)/i)), (r.axis = o && o[1] ? o[1] : "se"));
          }),
      ...
      _mouseStop: function (e) {
        ...
        return (
          this._helper &&
            ((n =
              (s = (i = this._proportionallyResizeElements).length && /textarea/i.test(i[0].nodeName)) && this._hasScroll(i[0], "left")
                ? 0
          ...
          (this.element
            ...
            .each(function () {
              ...
              if (
                ...
                w(s, t.extend(i, { offset: i.element.offset() }), i.options.tolerance, e)
              )
                return (n = !0), !1;
            }),
          !n &&
  ...
  var w = (t.ui.intersect = (function () {
    ...
    return function (e, i, s, n) {
      ...
      switch (s) {
        ...
        case "intersect":
          return (
            h < o + e.helperProportions.width / 2 &&
        ...
        case "touch":
          return (
            ((a >= c && a <= d) || (l >= c && l <= d) || (a < c && l > d)) && ((o >= h && o <= u) || (r >= h && r <= u) || (o < h && r > u))
          );
        default:
          return !1;
      }
    ...
    drop: function (e, i) {
      ...
      return (
        t.each((t.ui.ddmanager.droppables[e.options.scope] || []).slice(), function () {
          this.options &&
            (!this.options.disabled && this.visible && w(e, this, this.options.tolerance, i) && (s = this._drop.call(this, i) || s),
            !this.options.disabled &&
              this.visible &&
        ...
        t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function () {
          if (!this.options.disabled && !this.greedyChild && this.visible) {
            var s,
              n,
              o,
              a = w(e, this, this.options.tolerance, i),
        ...
        this.valueDiv.toggle(this.indeterminate || e > this.min).width(i.toFixed(0) + "%"),
          ...
          this.indeterminate
            ? (this.element.removeAttr("aria-valuenow"),
              this.overlayDiv ||
                ((this.overlayDiv = t("<div>").appendTo(this.valueDiv)), this._addClass(this.overlayDiv, "ui-progressbar-overlay")))
            ...
            this.selectees.each(function () {
              ...
              i &&
                ...
                "touch" === n.tolerance
                  ...
                  : "fit" === n.tolerance && (h = c.left > o && c.right < r && c.top > a && c.bottom < l),
                h
                  ? (i.selected && (s._removeClass(i.$element, "ui-selected"), (i.selected = !1)),
                    ...
                    i.selecting ||
                      (s._addClass(i.$element, "ui-selecting"), (i.selecting = !0), s._trigger("selecting", e, { selecting: i.element })))
                  : (i.selecting &&
      ...
      t.ui.formResetMixin,
      {
        ...
        _move: function (t, e) {
          ...
          this.isOpen
            ...
            (s = "first" === t || "last" === t ? i["first" === t ? "prevAll" : "nextAll"](n).eq(-1) : i[t + "All"](n).eq(0)).length &&
    ...
    t.widget("ui.slider", t.ui.mouse, {
      ...
      _slide: function (t, e, i) {
        ...
        this._hasMultipleValues() &&
          ...
          (a[e] = i)),
          i !== o &&
            !1 !== (s = this._trigger("slide", t, this._uiHash(e, i, a))) &&
      ...
      values: function (e, i) {
        ...
        for (o = 0, s = this.options.values, n = arguments[0]; o < s.length; o += 1)
          ...
          switch (e.keyCode) {
            ...
            case t.ui.keyCode.LEFT:
              if (
                (e.preventDefault(),
                !this._keySliding &&
                  ((this._keySliding = !0), this._addClass(t(e.target), null, "ui-state-active"), !1 === (i = this._start(e, a))))
              )
                return;
          }
    ...
    t.widget("ui.sortable", t.ui.mouse, {
      ...
      _mouseStart: function (e, i, s) {
        ...
        if (
          ...
          a.opacity &&
            (this.helper.css("opacity") && (this._storedOpacity = this.helper.css("opacity")), this.helper.css("opacity", a.opacity)),
          ...
          for (var e = this.containers.length - 1; e >= 0; e--)
            this.containers[e]._trigger("deactivate", null, this._uiHash(this)),
              this.containers[e].containerCache.over &&
                (this.containers[e]._trigger("out", null, this._uiHash(this)), (this.containers[e].containerCache.over = 0));
        }
        return (
          this.placeholder &&
              ...
              (o = t.data(n[s], this.widgetFullName)) &&
                ...
                r.push([
                  t.isFunction(o.options.items)
                    ...
                    : t(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),
                  o,
                ]);
        function h() {
          a.push(this);
      ...
      _refreshItems: function (e) {
        ...
        for (i = u.length - 1; i >= 0; i--)
          for (s = 0, a = u[i][1], h = (r = u[i][0]).length; s < h; s++)
            (l = t(r[s])).data(this.widgetName + "-item", a), c.push({ item: l, instance: a, width: 0, height: 0, left: 0, top: 0 });
      },
          ...
          if (!t.contains(this.currentItem[0], this.containers[i].element[0])) {
            if (this._intersectsWith(this.containers[i].containerCache)) {
              ...
              this.containers[i].containerCache.over &&
                (this.containers[i]._trigger("out", e, this._uiHash(this)), (this.containers[i].containerCache.over = 0));
          }
        if (d) {
          if (1 === this.containers.length)
            ...
            for (
              ...
              t.contains(this.containers[p].element[0], this.items[s].item[0]) &&
                ...
                Math.abs(e[u] - l) < n && ((n = Math.abs(e[u] - l)), (o = this.items[s]), (this.direction = h ? "up" : "down")));
            if (!o && !this.options.dropOnEmpty) return;
            if (this.currentContainer === this.containers[p]) {
              this.currentContainer.containerCache.over ||
                (this.containers[p]._trigger("over", e, this._uiHash()), (this.currentContainer.containerCache.over = 1));
              return;
            }
